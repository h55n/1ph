    ...
    (
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          {deadline && (
            <span style={{ fontFamily: 'monospace', fontSize: '16px', color: '#E8C468', marginLeft: 'auto' }}>
              {deadline}
            </span>
          )}
        </div>
        ...
        <div>
          <p style={{ fontFamily: 'monospace', fontSize: '18px', color: '#9E8A7A', marginBottom: '16px' }}>
            {organizer}
          </p>
          <h1
            style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontFamily: 'monospace', fontSize: '14px', color: '#91B2DD' }}>
            1ph.dev — Every hackathon. One place.
          </span>
        </div>
      </div>
    ),
